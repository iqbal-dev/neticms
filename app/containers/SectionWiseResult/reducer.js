/*
 *
 * SectionWiseResult reducer
 *
 */

import { fromJS } from 'immutable';
import { DEFAULT_ACTION,SET_SECTION_WISE_RESULT_DATA, SET_ACADEMIC_YEAR, SET_EXAM_LIST,SET_ACADEMIC_YEAR_LIST, SET_SECTION_LIST,SET_ON_CHANGE_EXAM_TYPE, SET_ON_CHANGE_SECTION } from './constants';
...
function sectionWiseResultReducer(state = initialState, action) {
  switch (action.type) {
    case DEFAULT_ACTION:
      return state;
      ...
      case SET_SECTION_WISE_RESULT_DATA:
        return state.set('sectionWiseResultData', action.sectionWiseResultData);
...
export default sectionWiseResultReducer;
