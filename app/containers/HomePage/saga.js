...
export function* fetch_Menu_byUrlId(urlInfoId) {
  ...
  const requestURL = BASE_URL_NETI_CMS.concat(fetch_menu_urlName).concat('?urlid=').concat(urlInfoId);
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
export function* fetch_LatestNews() {
  ...
  const requestURL = BASE_URL_NETI_CMS.concat(fetch_LatestNews);
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
export function* fetch_WelcomeSpeech_byUrlId(urlInfoId) {
  ...
  const requestURL = BASE_URL_NETI_CMS.concat(fetch_welcomeSpeechBy_urlId).concat('?urlid=').concat(urlInfoId);
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
export function* fetch_instituteHistory_byUrlId(urlInfoId) {
  ...
  const requestURL = BASE_URL_NETI_CMS.concat(fetch_instituteHistoryBy_urlId).concat('?type=').concat('History').concat('&urlid=').concat(urlInfoId);
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
...
export function* fetch_instituteTopEvent_byUrlId(urlInfoId) {
  ...
  const requestURL = BASE_URL_NETI_CMS.concat(fetch_instituteTopEventBy_urlId).concat('?urlid=').concat(urlInfoId);
  const options = {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
